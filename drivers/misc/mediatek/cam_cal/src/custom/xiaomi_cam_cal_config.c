...
#if defined(RUBENS_CAM) | defined(PLATO_CAM)
	unsigned char lens_id = 0xFF;
#endif
...
#if defined(MATISSE_CAM) || defined(RUBENS_CAM) || defined(DAUMIER_CAM) || defined(YUECHU_CAM)
	if (0xfad2 == pCamCalData->sensorID ||
		0x0582 == pCamCalData->sensorID ||
		0x0707 == pCamCalData->sensorID ||
		0x002B == pCamCalData->sensorID ||
		0x0842 == pCamCalData->sensorID ) //YUECHUS5KGD2_SENSOR_ID 
