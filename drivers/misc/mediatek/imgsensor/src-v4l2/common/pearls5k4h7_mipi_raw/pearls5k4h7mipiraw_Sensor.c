 ...
 *============================================================================
 ****************************************************************************/
#define PFX "PEARLS5K4H7_camera_sensor"
...
#include "pearls5k4h7_ana_gain_table.h"
#include "pearls5k4h7mipiraw_Sensor.h"
...
#define pearls5k4h7_table_write_cmos_sensor(...) subdrv_i2c_wr_regs_u8(__VA_ARGS__)
#define LOG_TAG "[pearls5k4h7]"
...
static kal_uint32 pearls5k4h7_awb_gain(struct subdrv_ctx *ctx,
...
static void pearls5k4h7_set_lsc_reg_setting(struct subdrv_ctx *ctx,
...
static void sensor_init(struct subdrv_ctx *ctx)
{
	...
	pearls5k4h7_table_write_cmos_sensor(ctx, pearls5k4h7_init_setting,
		sizeof(pearls5k4h7_init_setting) / sizeof(kal_uint16));
...
static void preview_setting(struct subdrv_ctx *ctx)
{
	...
	pearls5k4h7_table_write_cmos_sensor(ctx, pearls5k4h7_preview_setting,
			sizeof(pearls5k4h7_preview_setting) / sizeof(kal_uint16));
...
{
	S5K4H7_LOG_INF("+\n");
	pearls5k4h7_table_write_cmos_sensor(ctx, pearls5k4h7_normal_video_setting,
		sizeof(pearls5k4h7_normal_video_setting)/sizeof(kal_uint16));
	S5K4H7_LOG_INF("-\n");
}
...
static void custom1_setting(struct subdrv_ctx *ctx)
{
	...
	pearls5k4h7_table_write_cmos_sensor(ctx, pearls5k4h7_custom1_setting,
			sizeof(pearls5k4h7_custom1_setting) / sizeof(kal_uint16));
...
static void custom2_setting(struct subdrv_ctx *ctx)
{
	...
	pearls5k4h7_table_write_cmos_sensor(ctx, pearls5k4h7_custom2_setting,
			sizeof(pearls5k4h7_custom2_setting) / sizeof(kal_uint16));
		...
		UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
		if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL) {
			*(feature_data + 0) =
				sizeof(pearls5k4h7_ana_gain_table);
		} else {
			memcpy((void *)(uintptr_t) (*(feature_data + 1)),
			(void *)pearls5k4h7_ana_gain_table,
			sizeof(pearls5k4h7_ana_gain_table));
		}
		break;
...
break;
	...
	case SENSOR_FEATURE_SET_LSC_TBL:
		...
		pearls5k4h7_set_lsc_reg_setting(ctx, index, feature_data_16,
...
const struct subdrv_entry pearls5k4h7_mipi_raw_entry = {
	.name = "pearls5k4h7_mipi_raw",
	.id = PEARLS5K4H7_SENSOR_ID,
	.pw_seq = pw_seq,
