 ...
 *============================================================================
 ****************************************************************************/
#define PFX "YUECHUGC02M1_camera_sensor"
...
#include "yuechugc02m1_ana_gain_table.h"
#include "yuechugc02m1mipiraw_Sensor.h"
...
#define yuechugc02m1_table_write_cmos_sensor(...) subdrv_i2c_wr_regs_u8_u8(__VA_ARGS__)
#define LOG_TAG "[yuechugc02m1]"
#define GC02M1_LOG_INF(format, args...) pr_debug(LOG_TAG "[%s] " format, __func__, ##args)
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = YUECHUGC02M1_SENSOR_ID,
...
static kal_uint32 yuechugc02m1_awb_gain(struct subdrv_ctx *ctx,
...
static void yuechugc02m1_set_lsc_reg_setting(struct subdrv_ctx *ctx,
...
static void sensor_init(struct subdrv_ctx *ctx)
{
    ...
    // Global
	yuechugc02m1_table_write_cmos_sensor(ctx, yuechugc02m1_init_setting,
		sizeof(yuechugc02m1_init_setting) / sizeof(kal_uint16));
		...
		UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_ANA_GAIN_TABLE:
		if ((void *)(uintptr_t) (*(feature_data + 1)) == NULL) {
			*(feature_data + 0) =
				sizeof(yuechugc02m1_ana_gain_table);
		} else {
			memcpy((void *)(uintptr_t) (*(feature_data + 1)),
			(void *)yuechugc02m1_ana_gain_table,
			sizeof(yuechugc02m1_ana_gain_table));
		}
		break;
	...
	case SENSOR_FEATURE_SET_LSC_TBL:
		...
		yuechugc02m1_set_lsc_reg_setting(ctx, index, feature_data_16,
...
const struct subdrv_entry yuechugc02m1_mipi_raw_entry = {
	.name = "yuechugc02m1_mipi_raw",
	.id = YUECHUGC02M1_SENSOR_ID,
	.pw_seq = pw_seq,
